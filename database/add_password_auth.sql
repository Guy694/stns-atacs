...
ALTER TABLE `users`
  MODIFY COLUMN `thaid_cid` VARCHAR(13) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL
...
ALTER TABLE `users`
  ADD COLUMN `username` VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL
    COMMENT 'ชื่อผู้ใช้สำหรับ login แบบ username/password (ไม่บังคับ)'
    AFTER `email`,
  ADD COLUMN `password_hash` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL
