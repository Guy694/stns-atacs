...
CREATE TABLE `information_assets` (
  ...
  `asset_class` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'IT' COMMENT 'กลุ่มครุภัณฑ์รวม เช่น IT, Office, Medical, Vehicle',
  `asset_category` enum('Hardware','Software') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Hardware' COMMENT 'หมวดทรัพย์สินหลัก (Hardware/Software)',
  ...
  `windows_license_status` enum('Genuine','Pirated') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'สถานะลิขสิทธิ์ Windows: Genuine=แท้, Pirated=เถื่อน',
  ...
  `asset_image_1_url` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'รูปภาพอุปกรณ์ภาพที่ 1',
  `asset_image_2_url` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'รูปภาพอุปกรณ์ภาพที่ 2',
  ...
  KEY `idx_information_assets_asset_class` (`asset_class`),
