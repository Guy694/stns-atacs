...
-- MySQL requires the referenced FK column to be indexed before creating
-- agent_devices.linked_asset_id -> information_assets.id. Some imported
-- dumps add the information_assets primary key later, so guard this migration.
...
CREATE TABLE IF NOT EXISTS `agent_devices` (
  ...
  `disk_free_gb` int DEFAULT NULL,
  `disk_used_gb` int DEFAULT NULL,
