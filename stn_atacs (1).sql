...
--
-- Host: db:3306
-- Generation Time: May 21, 2026 at 03:08 AM
...
CREATE TABLE `agent_devices` (
  ...
  `bios_serial` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `device_type` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `manufacturer_brand` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `manufacturer_model` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `private_ip` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mac_address` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `current_user` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cpu_model` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `agent_version` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'online',
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `first_seen_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `last_seen_at` datetime DEFAULT NULL,
  `last_reported_at` datetime DEFAULT NULL,
  `raw_payload_json` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ข้อมูล inventory ที่รายงานจาก ATACS Agent';

-- --------------------------------------------------------

--
-- Table structure for table `agent_enrollments`
--

CREATE TABLE `agent_enrollments` (
  `id` int NOT NULL,
  `facility_id` int NOT NULL COMMENT 'ผูก enrollment token กับหน่วยงานเดียวเสมอ',
  `enrollment_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'ชื่อกำกับชุด token เช่น OPD Ward A',
  ...
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Enrollment token สำหรับติดตั้ง ATACS Agent ตามหน่วยงาน';

--
-- Dumping data for table `agent_enrollments`
--

INSERT INTO `agent_enrollments` (`id`, `facility_id`, `enrollment_name`, `token_hash`, `is_active`, `expires_at`, `created_by_user_id`, `last_used_at`, `created_at`) VALUES
(1, 14, 'self-service:officer-3', 'bff4431af89dabe04126adb4bf815fdf3d6ded2dc73d1fad86d23ec77b3dbccd', 0, '2026-05-22 06:05:33', 3, NULL, '2026-05-15 06:05:33'),
(2, 14, 'self-service:officer-3', '4a249e91bb9d9c7bc502f5d77e0b5f56bec04a10468d2dcd8e2f45b9d12c1d09', 0, '2026-05-22 06:05:52', 3, NULL, '2026-05-15 06:05:52'),
(3, 14, 'self-service:officer-3', 'b6b67c539042ebb57bd847dcfd97f807ee66192d5a56ad3ffcf553146c7ff67d', 0, '2026-05-22 06:17:04', 3, NULL, '2026-05-15 06:17:04'),
(4, 44, 'self-service:officer-3', '68d9baaa40c88d059e2002b5c6e273f0b9832131cb30b8b008014aa94c1a2062', 0, '2026-05-22 07:53:31', 3, NULL, '2026-05-15 07:53:31'),
(5, 44, 'self-service:officer-3', '86d1619e34ca5e3bb2e3f090821316d9ae9e16b2358959a30b4498a2c6f25c98', 0, '2026-05-22 07:53:54', 3, NULL, '2026-05-15 07:53:54'),
(6, 44, 'self-service:officer-3', '715a4984205199d8f05a4bd5c5aee3ebfa48f4a8a40a9375feb0281114711307', 0, '2026-05-22 08:52:42', 3, NULL, '2026-05-15 08:52:42'),
(7, 44, 'self-service:officer-3', '122e2e5a710c0c78a35e8defcd4905b401e05c0f14785e8e1a4636ec7ef2305b', 1, '2026-05-24 08:04:10', 3, NULL, '2026-05-17 08:04:10');

-- --------------------------------------------------------

--
-- Table structure for table `asset_device_types`
--

CREATE TABLE `asset_device_types` (
  `id` int NOT NULL,
  `name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'ชื่อประเภท เช่น Server, Firewall, Switch',
  `category` enum('Hardware','Software') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Hardware',
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `sort_order` int NOT NULL DEFAULT '0',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ประเภทอุปกรณ์/ซอฟต์แวร์สารสนเทศ';

--
-- Dumping data for table `asset_device_types`
--

INSERT INTO `asset_device_types` (`id`, `name`, `category`, `is_active`, `sort_order`, `created_at`, `updated_at`) VALUES
(1, 'Server', 'Hardware', 1, 10, '2026-05-14 03:59:16', '2026-05-14 03:59:16'),
(2, 'PC / Workstation', 'Hardware', 1, 20, '2026-05-14 03:59:16', '2026-05-14 03:59:16'),
(3, 'Notebook', 'Hardware', 1, 30, '2026-05-14 03:59:16', '2026-05-14 03:59:16'),
(4, 'Tablet', 'Hardware', 1, 40, '2026-05-14 03:59:16', '2026-05-14 03:59:16'),
(5, 'Printer', 'Hardware', 1, 50, '2026-05-14 03:59:16', '2026-05-14 03:59:16'),
(6, 'Scanner', 'Hardware', 1, 60, '2026-05-14 03:59:16', '2026-05-14 03:59:16'),
(7, 'Firewall', 'Hardware', 1, 70, '2026-05-14 03:59:16', '2026-05-14 03:59:16'),
(8, 'Switch', 'Hardware', 1, 80, '2026-05-14 03:59:16', '2026-05-14 03:59:16'),
(9, 'Router', 'Hardware', 1, 90, '2026-05-14 03:59:16', '2026-05-14 03:59:16'),
(10, 'Access Point', 'Hardware', 1, 100, '2026-05-14 03:59:16', '2026-05-14 03:59:16'),
(11, 'NAS / Storage', 'Hardware', 1, 110, '2026-05-14 03:59:16', '2026-05-14 03:59:16'),
(12, 'UPS', 'Hardware', 1, 120, '2026-05-14 03:59:16', '2026-05-14 03:59:16'),
(13, 'Projector', 'Hardware', 1, 130, '2026-05-14 03:59:16', '2026-05-14 03:59:16'),
(14, 'IP Camera', 'Hardware', 1, 140, '2026-05-14 03:59:16', '2026-05-14 03:59:16'),
(15, 'อื่นๆ (Hardware)', 'Hardware', 1, 999, '2026-05-14 03:59:16', '2026-05-14 03:59:16'),
(16, 'HIS', 'Software', 1, 10, '2026-05-14 03:59:16', '2026-05-14 03:59:16'),
(17, 'ERP', 'Software', 1, 20, '2026-05-14 03:59:16', '2026-05-14 03:59:16'),
(18, 'OS License', 'Software', 1, 30, '2026-05-14 03:59:16', '2026-05-14 03:59:16'),
(19, 'Antivirus', 'Software', 1, 40, '2026-05-14 03:59:16', '2026-05-14 03:59:16'),
(20, 'อื่นๆ (Software)', 'Software', 1, 999, '2026-05-14 03:59:16', '2026-05-14 03:59:16');
...
CREATE TABLE `asset_inspections` (
  `id` int NOT NULL,
  `facility_id` int NOT NULL,
  `round_name` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'ชื่อรอบการตรวจนับ เช่น ตรวจนับ Q1/2569',
  `inspected_by` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `asset_inspections` (`id`, `facility_id`, `round_name`, `inspected_by`, `inspected_at`, `note`, `created_at`) VALUES
(1, 14, 'Q1', 'อิรฟาน หลงเด็น', '2026-05-14 06:17:59', NULL, '2026-05-14 06:17:59');

-- --------------------------------------------------------

--
-- Table structure for table `asset_inspection_items`
--
...
CREATE TABLE `audit_logs` (
  ...
  `summary` text COMMENT 'คำอธิบายการเปลี่ยนแปลง',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `audit_logs` (`id`, `user_id`, `user_name`, `action`, `entity`, `entity_id`, `summary`, `created_at`) VALUES
(1, 1, 'อิรฟาน หลงเด็น', 'create', 'information_assets', 21, 'สร้างทรัพย์สิน window 10 (ss123)', '2026-05-14 04:13:44'),
(2, 1, 'อิรฟาน หลงเด็น', 'create', 'information_assets', 22, 'สร้างทรัพย์สิน window 10 (ss124)', '2026-05-14 04:14:59'),
(3, 1, 'อิรฟาน หลงเด็น', 'inspect', 'asset_inspections', 1, 'ตรวจนับทรัพย์สิน Q1 หน่วยบริการ 14 จำนวน 0 รายการ', '2026-05-14 06:17:59');
...
(23, 1, 'c1dd5b035659f2642c637e35df553646d6a35f0daa8a920f05ab3118d93fbdde', '2026-05-28 10:01:46', '2026-05-21 03:01:45');
...
CREATE TABLE `information_assets` (
  ...
  `purchase_price` decimal(15,2) DEFAULT NULL COMMENT 'ราคาที่ซื้อ (บาท)',
  `purchase_date` date DEFAULT NULL COMMENT 'วันที่ซื้อ/ได้รับมอบ',
  `purchase_order_no` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'เลขที่สัญญา/ใบสั่งซื้อ/PO',
...
INSERT INTO `information_assets` (`id`, `survey_id`, `row_no`, `asset_registration_no`, `asset_name`, `usage_description`, `owner_name`, `asset_category`, `asset_group`, `device_type`, `operating_system`, `operating_system_version`, `private_ip`, `public_ip`, `location_detail`, `installed_at`, `last_updated_at`, `current_status`, `updated_by`, `manufacturer_brand`, `manufacturer_model`, `manufacturer_specification`, `serial_number`, `purchase_price`, `purchase_date`, `purchase_order_no`, `maintenance_start_date`, `maintenance_end_date`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 'SAT-MOPH-HW-0001', 'Core Firewall', 'ควบคุมการเข้าออกเครือข่ายส่วนกลางของจังหวัด', 'นายอิรฟาน หลงเด็น', 'Hardware', 'Network', 'Firewall', 'FortiOS 7.4', NULL, '10.10.0.1', '203.113.10.5', 'Data Corner ชั้น 2 อาคารอำนวยการ', NULL, NULL, 'Active', 'Sa Admin', 'Fortinet', NULL, NULL, 'FGT90G-SATUL-01', NULL, NULL, NULL, '2024-05-28', '2026-05-28', '2026-05-11 08:36:58', '2026-05-11 08:36:58'),
(2, 1, 2, 'SAT-MOPH-SYS-0002', 'VM Host A', 'รัน HIS, dashboard และระบบรายงานภายใน', 'นางสาวสุชาดา ทองมาก', 'Software', 'System', 'Linux', 'Ubuntu Server 24.04', NULL, '10.10.0.20', NULL, 'Server Rack A1', NULL, NULL, 'Active', 'NOC Satun', 'Dell', NULL, NULL, 'DL-SATUL-A1', NULL, NULL, NULL, '2024-10-15', '2026-10-15', '2026-05-11 08:36:58', '2026-05-11 08:36:58'),
(3, 1, 3, 'SAT-MOPH-NW-0003', 'Core Switch L3', 'กระจายสัญญาณหลักระหว่าง VLAN ภายในสสจ.', 'นายอิรฟาน หลงเด็น', 'Hardware', 'Network', 'Switch', 'ArubaOS 10.x', NULL, '10.10.0.2', NULL, 'Data Corner ชั้น 2 อาคารอำนวยการ', NULL, NULL, 'Active', 'Sa Admin', 'HP Aruba', NULL, NULL, 'ARB-5400-MOPH-01', NULL, NULL, NULL, '2024-12-31', '2026-12-31', '2026-05-11 08:36:58', '2026-05-11 08:36:58'),
(4, 1, 4, 'SAT-MOPH-HW-0004', 'UPS ระบบกลาง', 'สำรองไฟสำหรับห้อง Server และ Network ชั้น 2', 'นางสาวสุชาดา ทองมาก', 'Hardware', 'Hardware', 'UPS', 'Firmware (APC)', NULL, '-', NULL, 'ห้อง Server ชั้น 2 อาคารอำนวยการ', NULL, NULL, 'Active', 'Sa Admin', 'APC', NULL, NULL, 'APC-SMART5K-MOPH-01', NULL, NULL, NULL, '2025-03-15', '2027-03-15', '2026-05-11 08:36:58', '2026-05-11 08:36:58'),
(5, 2, 1, 'SAT-HOS-HW-0108', 'X-Ray Review Workstation', 'เครื่องอ่านผลภาพถ่ายรังสี', 'นายธีรพงศ์ ชูช่วย', 'Hardware', 'Hardware', 'Windows', 'Windows 11 Pro', NULL, '172.16.8.21', NULL, 'ห้อง X-Ray OPD', NULL, NULL, 'Active', 'ศูนย์ IT รพ.สตูล', 'HP', NULL, NULL, 'HPXR-8841', NULL, NULL, NULL, '2024-06-11', '2026-06-11', '2026-05-11 08:36:58', '2026-05-11 08:36:58'),
(6, 2, 2, 'SAT-HOS-NW-0114', 'Radiology Switch', 'กระจายสัญญาณห้องรังสีและ PACS', 'นายธีรพงศ์ ชูช่วย', 'Hardware', 'Network', 'Switch', 'Embedded OS', NULL, '172.16.8.2', NULL, 'Rack R2 ห้องรังสี', NULL, NULL, 'Broken', 'Field Audit 2', 'Cisco', NULL, NULL, 'CSW-RD-0114', NULL, NULL, NULL, '2024-05-19', '2026-05-19', '2026-05-11 08:36:58', '2026-05-11 08:36:58'),
(7, 2, 3, 'SAT-HOS-SYS-0115', 'HIS Application Server', 'ให้บริการระบบ HIS สำหรับแผนกทั้งหมดของโรงพยาบาล', 'นายธีรพงศ์ ชูช่วย', 'Software', 'System', 'Linux', 'CentOS 7', NULL, '172.16.1.10', NULL, 'Server Rack หลัก ห้องสื่อสาร', NULL, NULL, 'Active', 'ศูนย์ IT รพ.สตูล', 'Dell', NULL, NULL, 'DL-HIS-SRV-HOSP-01', NULL, NULL, NULL, '2024-08-30', '2026-08-30', '2026-05-11 08:36:58', '2026-05-11 08:36:58'),
(8, 2, 4, 'SAT-HOS-NW-0116', 'Internet Edge Router', 'เชื่อมต่ออินเทอร์เน็ตหลักของโรงพยาบาล', 'นายธีรพงศ์ ชูช่วย', 'Hardware', 'Network', 'Router', 'RouterOS v7', NULL, '172.16.0.1', '49.228.110.20', 'ห้องสื่อสาร ชั้น 1 อาคาร OPD', NULL, NULL, 'Active', 'ศูนย์ IT รพ.สตูล', 'MikroTik', NULL, NULL, 'MTK-RB1100-HOSP-01', NULL, NULL, NULL, '2024-11-20', '2026-11-20', '2026-05-11 08:36:58', '2026-05-11 08:36:58'),
(9, 3, 1, 'SAT-LNG-ST-0203', 'NAS Backup Unit', 'เก็บข้อมูลสำรองระบบห้องคลอดและการเงิน', 'นางสาวอาซียะห์ ดอเลาะ', 'Hardware', 'Storage', 'NAS', 'Synology DSM 7.2', NULL, '10.20.4.10', NULL, 'ห้องแม่ข่าย ชั้น 1', NULL, NULL, 'Inactive', 'ทีมสำรวจละงู', 'Synology', NULL, NULL, 'SYN-0203-LNG', NULL, NULL, NULL, '2024-05-22', '2026-05-22', '2026-05-11 08:36:58', '2026-05-11 08:36:58'),
(10, 3, 2, 'SAT-LNG-SYS-0204', 'AD Domain Controller', 'จัดการสิทธิ์ผู้ใช้งานในเครือข่ายโรงพยาบาล', 'นายวสันต์ นวลแก้ว', 'Software', 'System', 'Windows', 'Windows Server 2022', NULL, '10.20.4.12', '1.20.130.44', 'Server Rack B2', NULL, NULL, 'Active', 'NOC Satun', 'Lenovo', NULL, NULL, 'LNV-0204-DC', NULL, NULL, NULL, '2024-07-30', '2026-07-30', '2026-05-11 08:36:58', '2026-05-11 08:36:58'),
(11, 3, 3, 'SAT-LNG-HW-0205', 'Network Laser Printer', 'พิมพ์เอกสารทั่วไปและใบเสร็จรับเงินสำหรับแผนกเวชระเบียน', 'นายวสันต์ นวลแก้ว', 'Hardware', 'Hardware', 'Printer', 'Embedded OS', NULL, '10.20.4.50', NULL, 'ห้องเวชระเบียน ชั้น 1', NULL, NULL, 'Active', 'ทีมสำรวจละงู', 'HP', NULL, NULL, 'HPP-LJP4015-LNG-01', NULL, NULL, NULL, '2025-01-10', '2027-01-10', '2026-05-11 08:36:58', '2026-05-11 08:36:58'),
(12, 4, 1, 'SAT-KLG-HW-0301', 'Firewall UTM', 'ป้องกันเครือข่ายและกรองทราฟฟิคขาเข้า-ขาออกของโรงพยาบาล', 'นายกมล แซ่โค้ว', 'Hardware', 'Network', 'Firewall', 'FortiOS 7.4', NULL, '192.168.1.1', '1.1.228.35', 'Data Room ชั้น 1 อาคารอำนวยการ', NULL, NULL, 'Active', 'ทีมสำรวจควนกาหลง', 'Fortinet', NULL, NULL, 'FGT60F-KLG-01', NULL, NULL, NULL, '2024-09-15', '2026-09-15', '2026-05-11 08:36:58', '2026-05-11 08:36:58'),
(13, 4, 2, 'SAT-KLG-NW-0302', 'Core Switch', 'กระจายสัญญาณหลักระหว่างแผนกต่าง ๆ ภายในโรงพยาบาล', 'นายกมล แซ่โค้ว', 'Hardware', 'Network', 'Switch', 'Embedded OS', NULL, '192.168.1.2', NULL, 'Data Room ชั้น 1 อาคารอำนวยการ', NULL, NULL, 'Active', 'ทีมสำรวจควนกาหลง', 'Cisco', NULL, NULL, 'CSW-KLG-C2960-01', NULL, NULL, NULL, '2024-06-05', '2026-06-05', '2026-05-11 08:36:58', '2026-05-11 08:36:58'),
(14, 4, 3, 'SAT-KLG-HW-0303', 'OPD Workstation', 'ใช้บันทึกข้อมูลผู้ป่วยนอกและออกใบสั่งยา', 'นางสาวมาเรียม สาเรง', 'Hardware', 'Hardware', 'Windows', 'Windows 10 Pro', NULL, '192.168.2.44', NULL, 'ห้อง OPD ชั้น 1', NULL, NULL, 'Broken', 'ทีมสำรวจควนกาหลง', 'Lenovo', NULL, NULL, 'LNV-OPD-KLG-0303', NULL, NULL, NULL, '2024-01-01', '2025-12-31', '2026-05-11 08:36:58', '2026-05-11 08:36:58'),
(15, 5, 1, 'SAT-THW-NW-0401', 'Internet Router', 'เชื่อมต่ออินเทอร์เน็ตผ่าน ISP และทำ NAT สำหรับเครือข่ายภายใน', 'นายสมชาย หาดทิพย์', 'Hardware', 'Network', 'Router', 'RouterOS v7', NULL, '10.30.0.1', '49.49.214.8', 'ห้องสื่อสาร ชั้น 1', NULL, NULL, 'Active', 'ทีมสำรวจทุ่งหว้า', 'MikroTik', NULL, NULL, 'MTK-CCR1009-THW-01', NULL, NULL, NULL, '2024-07-20', '2026-07-20', '2026-05-11 08:36:58', '2026-05-11 08:36:58'),
(16, 5, 2, 'SAT-THW-ST-0402', 'NAS Backup', 'สำรองข้อมูล EMR และภาพถ่ายทางการแพทย์ทุกคืน', 'นายสมชาย หาดทิพย์', 'Hardware', 'Storage', 'NAS', 'Synology DSM 7.2', NULL, '10.30.0.20', NULL, 'ห้อง Server ชั้น 2', NULL, NULL, 'Inactive', 'ทีมสำรวจทุ่งหว้า', 'Synology', NULL, NULL, 'SYN-DS923-THW-01', NULL, NULL, NULL, '2024-05-15', '2026-05-15', '2026-05-11 08:36:58', '2026-05-11 08:36:58'),
(17, 5, 3, 'SAT-THW-SYS-0403', 'Antivirus Management Server', 'บริหารจัดการ endpoint protection สำหรับเครื่องในโรงพยาบาลทั้งหมด', 'นายสมชาย หาดทิพย์', 'Software', 'System', 'Windows', 'Windows Server 2019', NULL, '10.30.0.30', NULL, 'Server Rack ห้อง Server ชั้น 2', NULL, NULL, 'Active', 'ทีมสำรวจทุ่งหว้า', 'Dell', NULL, NULL, 'DL-PE340-AV-THW-01', NULL, NULL, NULL, '2024-10-01', '2026-10-01', '2026-05-11 08:36:58', '2026-05-11 08:36:58'),
(18, 6, 1, 'SAT-MNG-NW-0501', 'Access Point Controller', 'ควบคุมและกระจายสัญญาณ Wi-Fi ภายในอาคารรักษาพยาบาลทั้งหมด', 'นายรุสดี สาและ', 'Hardware', 'Network', 'Access Point', 'UniFi Network OS', NULL, '10.40.0.10', NULL, 'ชั้น 1 อาคารรักษาพยาบาล', NULL, NULL, 'Active', 'ทีมสำรวจมะนัง', 'Ubiquiti', NULL, NULL, 'UAP-PRO-MNG-01', NULL, NULL, NULL, '2024-08-20', '2026-08-20', '2026-05-11 08:36:58', '2026-05-11 08:36:58'),
(19, 6, 2, 'SAT-MNG-SYS-0502', 'Patient DB Server', 'ฐานข้อมูลผู้ป่วยและประวัติการรักษาของโรงพยาบาลมะนัง', 'นายรุสดี สาและ', 'Software', 'System', 'Linux', 'Ubuntu Server 22.04 LTS', NULL, '10.40.0.20', NULL, 'ห้อง Server ชั้น 1', NULL, NULL, 'Active', 'ทีมสำรวจมะนัง', 'HP', NULL, NULL, 'HPE-ML30-MNG-01', NULL, NULL, NULL, '2024-12-25', '2026-12-25', '2026-05-11 08:36:58', '2026-05-11 08:36:58'),
(20, 6, 3, 'SAT-MNG-HW-0503', 'OPD Workstation 1', 'ใช้บันทึกข้อมูลผู้ป่วยนอกแผนกอายุรกรรม', 'นางสาวนิสา มาหะมะ', 'Hardware', 'Hardware', 'Windows', 'Windows 11 Pro', NULL, '10.40.2.11', NULL, 'ห้อง OPD แผนกอายุรกรรม', NULL, NULL, 'Broken', 'ทีมสำรวจมะนัง', 'Lenovo', NULL, NULL, 'LNV-OPD-MNG-0503', NULL, NULL, NULL, '2024-05-25', '2026-05-25', '2026-05-11 08:36:58', '2026-05-11 08:36:58'),
(21, 7, NULL, 'ss123', 'window 10', NULL, 'ประณต', 'Software', NULL, NULL, NULL, NULL, NULL, NULL, 'ห้องไอที 2', NULL, '2026-05-14', 'Active', 'อิรฟาน หลงเด็น', NULL, NULL, NULL, NULL, 2000.00, NULL, NULL, '2026-05-14', '2026-06-05', '2026-05-14 04:13:44', '2026-05-14 04:13:44'),
(22, 8, NULL, 'ss124', 'window 10', NULL, NULL, 'Software', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-05-14', 'Active', 'อิรฟาน หลงเด็น', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-05-14 04:14:59', '2026-05-14 04:14:59');
...
(7, 20, NULL, NULL, '2026-05-14', NULL, '2026-05-14 04:13:44', '2026-05-14 04:13:44'),
(8, 66, NULL, NULL, '2026-05-14', NULL, '2026-05-14 04:14:59', '2026-05-14 04:14:59');
...
CREATE TABLE `users` (
  ...
  `role` enum('admin','officer','viewer') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'officer' COMMENT 'บทบาทผู้ใช้ (admin=ผู้ดูแล, officer=เจ้าหน้าที่, viewer=ผู้ดูเท่านั้น)',
  `facility_id` int DEFAULT NULL COMMENT 'หน่วยงานที่สังกัด — ใช้สำหรับ officer / pending user',
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
...
--
-- Indexes for table `agent_devices`
--
ALTER TABLE `agent_devices`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_agent_devices_agent_uuid` (`agent_uuid`),
  ADD UNIQUE KEY `uk_agent_devices_facility_fingerprint` (`facility_id`,`device_fingerprint`),
  ADD KEY `idx_agent_devices_linked_asset_id` (`linked_asset_id`),
  ADD KEY `idx_agent_devices_enrollment_id` (`enrollment_id`),
  ADD KEY `idx_agent_devices_status` (`status`);

--
-- Indexes for table `agent_enrollments`
--
ALTER TABLE `agent_enrollments`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_agent_enrollments_token_hash` (`token_hash`),
  ADD KEY `idx_agent_enrollments_facility_id` (`facility_id`),
  ADD KEY `idx_agent_enrollments_active` (`is_active`),
  ADD KEY `fk_agent_enrollments_created_by_user` (`created_by_user_id`);

--
-- Indexes for table `asset_device_types`
--
ALTER TABLE `asset_device_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_asset_device_types_name_category` (`name`,`category`);
...
--
-- Indexes for table `asset_inspection_items`
--
ALTER TABLE `asset_inspection_items`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `agent_devices`
--
ALTER TABLE `agent_devices`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `agent_enrollments`
--
ALTER TABLE `agent_enrollments`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `asset_device_types`
--
ALTER TABLE `asset_device_types`
...
--
-- AUTO_INCREMENT for table `asset_inspection_items`
--
ALTER TABLE `asset_inspection_items`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `agent_devices`
--
ALTER TABLE `agent_devices`
  ADD CONSTRAINT `fk_agent_devices_asset` FOREIGN KEY (`linked_asset_id`) REFERENCES `information_assets` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_agent_devices_enrollment` FOREIGN KEY (`enrollment_id`) REFERENCES `agent_enrollments` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_agent_devices_facility` FOREIGN KEY (`facility_id`) REFERENCES `health_facilities` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

--
-- Constraints for table `agent_enrollments`
--
ALTER TABLE `agent_enrollments`
  ADD CONSTRAINT `fk_agent_enrollments_created_by_user` FOREIGN KEY (`created_by_user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_agent_enrollments_facility` FOREIGN KEY (`facility_id`) REFERENCES `health_facilities` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

--
-- Constraints for table `asset_inspection_items`
--
ALTER TABLE `asset_inspection_items`
  ADD CONSTRAINT `asset_inspection_items_ibfk_1` FOREIGN KEY (`inspection_id`) REFERENCES `asset_inspections` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `asset_inspection_items_ibfk_2` FOREIGN KEY (`asset_id`) REFERENCES `information_assets` (`id`) ON DELETE CASCADE;
